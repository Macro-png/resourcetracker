...
export function initHPControls() {
  ...
  maxReductionInput.addEventListener("keydown", (e) => {
    if (e.key === "Enter") maxReductionInput.blur();
  });
  ...
  document
    .getElementById("concentration-modal-fail")
  ...
  document
    .getElementById("concentration-modal-success")
    .addEventListener("click", () => {
      document.getElementById("concentration-modal").hidden = true;
    });
}
